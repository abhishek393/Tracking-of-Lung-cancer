...
def labelling():
    dict = []
    with open('/media/abhishek/New Volume/Kinect Project/data_mapped/labels.csv', 'w') as file:
        for j in range(1, 19):
            depth_path = '/media/abhishek/New Volume/Kinect Project/data/sub' + str(j) + '/DepthFrame'
